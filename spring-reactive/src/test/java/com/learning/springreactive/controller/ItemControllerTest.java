...
public class ItemControllerTest {
	...
	public void testfindAll() {
		...
		Flux<Item> fluxItem = webTestClient.get().uri("/v1/items").accept(MediaType.APPLICATION_STREAM_JSON).exchange()
	...
	public void testFindById() {
		...
		webTestClient.get().uri("/v1/items/" + idToFind).accept(MediaType.APPLICATION_STREAM_JSON).exchange()
	...
	public void testCreateSuccess() {
		...
		webTestClient.post().uri("/v1/items/").contentType(MediaType.APPLICATION_JSON_UTF8)
	...
	public void testDeleteById() {
		...
		webTestClient.delete().uri("/v1/items/" + idToDelete).accept(MediaType.APPLICATION_STREAM_JSON).exchange()
	...
	public void testUpdateItem() {
		...
		webTestClient.put().uri("/v1/items")
					 .accept(MediaType.APPLICATION_STREAM_JSON)
