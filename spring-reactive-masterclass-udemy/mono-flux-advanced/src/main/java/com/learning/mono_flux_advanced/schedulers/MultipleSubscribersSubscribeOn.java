...
public class MultipleSubscribersSubscribeOn {

	public static void main(String[] args) {
		
		Flux<String> data = Flux.create(MultipleSubscribersSubscribeOn :: createData);
		...
		.subscribe(new ThreadSubscriber<>(true, MultipleSubscribersSubscribeOn.class.getSimpleName()));
